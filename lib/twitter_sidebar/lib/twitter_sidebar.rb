class TwitterSidebar < Sidebar
    ...
    setting :show_header, true, label: 'Show Header', input_type: :checkbox, onclick: 'changeVal(this)'
    setting :show_footer, true, label: 'Show Footer', input_type: :checkbox, onclick: 'changeVal(this)'
